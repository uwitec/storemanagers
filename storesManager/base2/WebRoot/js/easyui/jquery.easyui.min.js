 ...
 * http://www.jeasyui.com/license_commercial.php 3159行修改窗口拖动问题
 */
(function($) {
	$.parser = {
		auto : true,
...
(function($) {
	...
	function _246(_247) {
		...
		_248.window.draggable({
			...
			/*
			 * 原方法 onStartDrag:function(e){ if(_248.mask){
			 ...
			 * if(!_248.proxy){ _248.proxy=$("<div class=\"window-proxy\"></div>").insertAfter(_248.window); }
			 ...
			 * setTimeout(function(){ if(_248.proxy){ _248.proxy.show(); }
			 * },500); },
			 */
			onDrag : function(e) {
				/*
			...
			onStopDrag : function(e) {
				/*
				 * 原方法 _248.options.left=e.data.left;
				 * _248.options.top=e.data.top; $(_247).window("move");
				 * _248.proxy.remove(); _248.proxy=null;
				 */
				/** ***************************修改方法begin********************************* */
				var d = e.data;
				if (d.left < 0) {
