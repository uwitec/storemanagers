orgAdd.jsp<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
		<script>
		$(function(){
	...
	<div class="content" align="center">
	    ...
	    <table width="600" border="0" align="center" cellpadding="3">
	      <tr>
	        <input type="hidden" name="org_upno" id="org_upno" />      
	        ...
	        <td width="30%"> <input type="text" name="org_lkman" id="org_lkman" maxLength="100" size="15"/></td>
	        <td width="20%" align="right"><label for="org_tel"><span class="x"></span>联系人电话：</label></td>
	        <td width="30%"> <input type="text" name="org_tel" id="org_tel" maxLength="100" size="15"/></td>
	      </tr>
	    </table>
	</div>
	<!-- 弹出框按钮 -->
